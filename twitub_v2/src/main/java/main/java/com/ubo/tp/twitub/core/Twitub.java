...
public class Twitub {
	 ...
	 */
	protected String mUiClassName = "com.sun.java.swing.plaf.windows.WindowsLookAndFeel";
	...
	private void spyOnDatabase() {
		//new DatabaseSpy(this.mDatabase);
	...
	protected void initDirectory() {
		File directory = this.mMainView.askDirectory();
